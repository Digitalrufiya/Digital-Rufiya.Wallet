// app.js — Fixed & Improved with your full Pinata JWT
...
// Your full Pinata JWT token here
...
uploadForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    // Save actual MIME type for correct video rendering
...
function renderPosts() {
  onValue(ref(db, "posts"), (snap) => {
    ...
    Object.entries(data)
      ...
      .forEach(([postId, post]) => {
        console.log("Rendering post media URL:", post.mediaUrl);
        ...
        card.innerHTML = `
          ...
          ${
            post.mediaType === "video"
              ? `<video controls preload="metadata" onerror="console.error('Video load error:', this.src)">
                   <source src="${post.mediaUrl}" type="${post.mediaMimeType}" />
                 </video>`
              : `<img src="${post.mediaUrl}" alt="Post media" onerror="this.onerror=null;this.src='fallback.jpg';" />`
          }
